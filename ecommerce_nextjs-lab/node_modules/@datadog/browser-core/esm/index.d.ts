...
export { validateAndBuildConfiguration, DefaultPrivacyLevel, TraceContextInjection, serializeConfiguration, isSampleRate, buildEndpointHost, INTAKE_SITE_STAGING, INTAKE_SITE_US1, INTAKE_SITE_US1_FED, INTAKE_SITE_EU1, INTAKE_URL_PARAMETERS, isIntakeUrl, } from './domain/configuration';
...
export type { Telemetry, RawTelemetryEvent, RawTelemetryConfiguration, TelemetryEvent, TelemetryErrorEvent, TelemetryDebugEvent, TelemetryConfigurationEvent, TelemetryUsageEvent, } from './domain/telemetry';
export { startTelemetry, addTelemetryDebug, addTelemetryError, startFakeTelemetry, resetTelemetry, TelemetryService, isTelemetryReplicationAllowed, addTelemetryConfiguration, addTelemetryUsage, drainPreStartTelemetry, } from './domain/telemetry';
...
SessionPersistence, } from './domain/session/sessionConstants';
export type { HttpRequest, Payload, FlushEvent, FlushReason } from './transport';
export { createHttpRequest, canUseEventBridge, getEventBridge, bridgeSupports, BridgeCapability, startBatchWithReplica, createFlushController, } from './transport';
...
export { createCustomerDataTrackerManager, createCustomerDataTracker, CUSTOMER_DATA_BYTES_LIMIT, CustomerDataCompressionStatus, } from './domain/context/customerDataTracker';
