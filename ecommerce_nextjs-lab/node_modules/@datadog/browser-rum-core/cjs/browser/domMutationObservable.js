...
function createDOMMutationObservable() {
    ...
    return new browser_core_1.Observable((observable) => {
        ...
        const observer = new MutationObserver((0, browser_core_1.monitor)(() => observable.notify()));
...
function getMutationObserverConstructor() {
    ...
    if (browserWindow.Zone) {
        ...
        if (browserWindow.MutationObserver && constructor === browserWindow.MutationObserver) {
            ...
            const patchedInstance = new browserWindow.MutationObserver(browser_core_1.noop);
            const originalInstance = (0, browser_core_1.getZoneJsOriginalValue)(patchedInstance, 'originalInstance');
