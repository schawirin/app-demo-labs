...
function getNodePrivacyLevel(node, defaultPrivacyLevel, cache) {
    ...
    const parentNode = (0, htmlDomUtils_1.getParentNode)(node);
...
function getNodeSelfPrivacyLevel(node) {
    ...
    if (node.matches(getPrivacySelector(exports.NodePrivacyLevel.HIDDEN))) {
        return exports.NodePrivacyLevel.HIDDEN;
    }
    if (node.matches(getPrivacySelector(exports.NodePrivacyLevel.MASK))) {
        return exports.NodePrivacyLevel.MASK;
    }
    if (node.matches(getPrivacySelector(exports.NodePrivacyLevel.MASK_USER_INPUT))) {
        return exports.NodePrivacyLevel.MASK_USER_INPUT;
    }
    if (node.matches(getPrivacySelector(exports.NodePrivacyLevel.ALLOW))) {
        return exports.NodePrivacyLevel.ALLOW;
    }
...
function getPrivacySelector(privacyLevel) {
    return `[${exports.PRIVACY_ATTR_NAME}="${privacyLevel}"], .${exports.PRIVACY_CLASS_PREFIX}${privacyLevel}`;
}
